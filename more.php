...
<title>Product Details 04 - Glowing - Bootstrap 5 HTML Templates</title>
...
<?php
    ...
    <!---------------back arrow---------------->
	 ...
	 <a href="javascript:history.go(-1)" style="border: 1px solid ; padding: 10px 20px; border-radius: 5px; margin: 50px; "><i class="fa-solid fa-arrow-left"></i></a>
...
<section class="container pt-6 pb-13 pb-lg-20">
	<div class="row ">
		<!-----------------------------images------------------------------>
		            <?php
		             ...
		             $sql = "SELECT  id, img_path, price_in_jo  FROM `products`  WHERE id = $id LIMIT 1";
		...
		<div class="col-md-6 pe-lg-13 pb-12">
			<div class="position-sticky top-0">
	            <a href="#" data-gallery="gallery4"><img src="#" data-src="upload/<?php echo $row["img_path"] ; ?>" class="lazy-image" width="540" height="720" alt=""></a>
			</div>
		</div>
		<?php
					 }
		...
		<div class="col-md-6 pt-md-0 pt-10">
		  <!------------------------price----------------------------------->
		<?php
		 $sql2 = "SELECT  id, img_path, price_in_jo, product_name, rating, description, skin_type  FROM `products`  WHERE id = $id LIMIT 1";
		...
		?>
		  <h1 class="mb-4 pb-2 fs-4"><?php echo $row2["product_name"] ?></h1>

          <p class="d-flex align-items-center mb-6">
			
		    <span class="fs-18px text-body-emphasis ps-6 fw-bold"><?php echo $row2["price_in_jo"] . " JD" ?></span>
    ...
    <div class="d-flex align-items-center fs-15px mb-6">
		<p class="mb-0 fw-semibold text-body-emphasis"><?php echo $row2["rating"] ?></p>
	...
	<div class="rating">
		...
		<ul class="post-meta list-inline lh-1 d-flex flex-wrap fs-13px text-uppercase ls-1 fw-semibold m-0">
			<?php if($number != null){
			for($starsnum=1 ; $starsnum<=$integerPart ; $starsnum++){
				$count++;
			?>
...
<!--<p class="fs-15px"><?php// echo $row2["description"] ?></p>
...
<!----------------------------------------------------------->
  ...
  <div class="mt-11">
	...
	<div id="flush-collapseOne" class="accordion-collapse collapse show" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
	 <div class="pt-8 pb-3">
			<p class="fw-semibold text-body-emphasis mb-2 pb-4">For <?php echo $row2["skin_type"] ?> Skin Type</p>
			<p class="mb-2 pb-4"><?php echo $row2["description"] ?></p>
...
<section class="container pt-15 pb-15 pt-lg-17 pb-lg-20">
	...
	<div class="slick-slider" data-slick-options="{&#34;arrows&#34;:true,&#34;centerMode&#34;:true,&#34;centerPadding&#34;:&#34;calc((100% - 1440px) / 2)&#34;,&#34;dots&#34;:true,&#34;infinite&#34;:true,&#34;responsive&#34;:[{&#34;breakpoint&#34;:1200,&#34;settings&#34;:{&#34;arrows&#34;:false,&#34;dots&#34;:false,&#34;slidesToShow&#34;:3}},{&#34;breakpoint&#34;:992,&#34;settings&#34;:{&#34;arrows&#34;:false,&#34;dots&#34;:false,&#34;slidesToShow&#34;:2}},{&#34;breakpoint&#34;:576,&#34;settings&#34;:{&#34;arrows&#34;:false,&#34;dots&#34;:false,&#34;slidesToShow&#34;:1}}],&#34;slidesToShow&#34;:4}">
	            <?php
				     $currentpro = "SELECT skin_type   FROM `products`  WHERE id = $id LIMIT 1 ";
				     $resucurrentpro = mysqli_query($conn, $currentpro);
					 $rowskin = mysqli_fetch_assoc($resucurrentpro);
					 $skin_type = $rowskin['skin_type'];
                     $sqlpro = "SELECT  id, img_path, price_in_jo, product_name, rating, boycott  FROM `products`  WHERE skin_type = '$skin_type' AND id != $id ";
					 $resultpr = mysqli_query($conn, $sqlpro);
    ...
    <figure class="card-img-top position-relative mb-7 overflow-hidden">
        <a href="more.php?id=<?php echo $rowpr["id"] ?>" class="hover-zoom-in d-block" title="Shield Conditioner">
          <img src="#" data-src="upload/<?php echo $rowpr["img_path"] ; ?>" class="img-fluid lazy-image w-100" alt="Shield Conditioner" width="330" height="440">
        </a>
        <?php
	      if($rowpr["boycott"] == 1){
        ?>
		<!---------------------------boycott------------------------------>
	<a href="alternative.php?id=<?php echo $rowpr["id"] ?>"  title="boycott">
        <div class="position-absolute product-flash z-index-2 ">
		  <span class="badge badge-product-flash on-sale bg-primary">
			<i class="fa-solid fa-caret-down" style="font-size: 30px; color: red;"></i>
		  </span>
		</div>
	</a>
		<!---------------------------/boycott------------------------------>
	...
	<!---------------------------/light------------------------------>
</div><a href="more.php?id=<?php echo $rowpr["id"] ?>" class="btn btn-add-to-cart btn-dark btn-hover-bg-primary btn-hover-border-primary position-absolute z-index-2 text-nowrap">View Details</a>
    </figure>
...
<span class="d-flex align-items-center price text-body-emphasis fw-bold justify-content-center mb-3 fs-6">
        ...
        <ins class="text-decoration-none"><?php echo $rowpr["price_in_jo"] . " JD" ?></ins></span>

        <h4 class="product-title card-title text-primary-hover text-body-emphasis fs-15px fw-500 mb-3"><?php echo $rowpr["product_name"] ?></h4>
       <!---------------------------rating------------------------------>
		<div class="d-flex align-items-center fs-12px justify-content-center">

		<?php
		 $number2 =  $rowpr["rating"] ;
		 $integerPart2 = floor($number2);
		 $decimalPart2 = fmod($number2, 1);
		 $count2 = 0;
	...
	<div class="rating">
		...
		<ul class="post-meta list-inline lh-1 d-flex flex-wrap fs-13px text-uppercase ls-1 fw-semibold m-0">
			<?php
			  if($number2 != null)
					 {
			for($starsnum=1 ; $starsnum<=$integerPart2 ; $starsnum++){
				$count2++;
			?>
	         <i class="fa-solid fa-star"></i>
			<?php
	...
	<span class="reviews ms-4 pt-3 fs-14px"><?php echo $number2; ?></span>
	<!---------------------------/rating------------------------------>
  </div>
 </div>
...
<section class="container pt-15 pb-15 pt-lg-17 pb-lg-20">
	...
	<div class="rating">
		...
		<div class="mb-10"><img src="#" data-src="./assets/images/others/single-product-03.jpg" class="mx-3 w-auto lazy-image" alt="">
			<img src="#" data-src="./assets/images/others/single-product-02-270x360.jpg.jpg" class="mx-3 w-auto lazy-image" alt="">
...
<div class="modal fade" id="quickViewModal" aria-labelledby="quickViewModal" aria-hidden="true">
	...
	<div id="slider" class="slick-slider slick-slider-arrow-inside slick-slider-dots-inside slick-slider-dots-light g-0" data-slick-options='{&#34;arrows&#34;:false,&#34;asNavFor&#34;:&#34;#slider-thumb&#34;,&#34;dots&#34;:false,&#34;slidesToShow&#34;:1}'>
			<a href="./assets/images/shop/product-02-270x360.jpg" data-gallery="gallery1"><img src="#" data-src="./assets/images/shop/product-02-270x360.jpg" class="h-auto lazy-image" width="540" height="720" alt=""></a>
...
<div class="mt-6">
	<div id="slider-thumb" class="slick-slider slick-slider-thumb ps-1 ms-n3 me-n4" data-slick-options='{&#34;arrows&#34;:false,&#34;asNavFor&#34;:&#34;#slider&#34;,&#34;dots&#34;:false,&#34;focusOnSelect&#34;:true,&#34;slidesToShow&#34;:5,&#34;vertical&#34;:false}'>
			<img src="#" data-src="./assets/images/shop/product-02-270x360.jpg.jpg-154x205.jpg" class="mx-3 px-0 h-auto cursor-pointer lazy-image" width="75" height="100" alt="">
...
<hr class="mt-0">
	...
	<li class="nav-item transition-all-xl-1 py-0 dropdown dropdown-fullwidth">
		<a class="nav-link d-flex justify-content-between position-relative text-uppercase fw-semibold ls-1 fs-15px dropdown-toggle"
		   href="./index.html" data-bs-toggle="dropdown" id="menu-item-home-canvas" aria-haspopup="true" aria-expanded="false">Home</a><div class="dropdown-menu mega-menu start-0 py-6 "
