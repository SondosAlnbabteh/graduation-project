...
<title>Blog Grid Sidebar - Glowing - Bootstrap 5 HTML Templates</title>
...
<main id="content" class="wrapper layout-page">
 ...
 <div class="text-center py-13">
        <div class="container">
            <h2 class="mb-0">Discover Skin Care Products</h2>
		</div>
 </div>
     </section>
	...
	<div class="row">
			...
			<div class="col-lg-4">
							...
							<form method="post" action="">
								<label class="mb-4 fs-13px ls-1 fw-bold text-uppercase" for="category">Choose Category</label>
			...
			<div class="col-lg-4">
							<div class="mb-8">
							<form action="searchajax.php" method="GET">
							<label class="mb-8 fs-13px ls-1 fw-bold text-uppercase" for="category"></label>

                                <div class="input-group mb-3">
                                        <input type="text" name="skincare3" required value="<?php if(isset($_GET['skincare3'])){echo $_GET['skincare3']; } ?>" class="form-control" placeholder="Search product">
		...
		<div class="col-lg-12">
			<div class="row gy-50px">
					...
					<?php
					   ...
					   $start = 0;
					   $rows_per_page = 12;
					   $sql2= "SELECT id, rating, product_name, price_in_jo, img_path, description, boycott FROM `products`";
					...
					if ($category != "0") {
						$sql = "SELECT  id, rating, product_name, price_in_jo, img_path, description, boycott, skin_type  FROM `products` WHERE category_id = $category LIMIT $start,$rows_per_page";
					
					}else{
					
						
					$sql = "SELECT  id, rating, product_name, price_in_jo, img_path, description, boycott, skin_type  FROM `products` LIMIT $start,$rows_per_page";
					}
...
?>
 <style>
        .btn-add-to-cart {
            border: none; /* إزالة الحدود بشكل كامل */
        }
        @keyframes bounce {
            0%, 100% {
                transform: translateY(0); /* في الإطارات الأولى والأخيرة، لا يوجد تحرك */
            }
            50% {
                transform: translateY(-5px); /* في الإطار الوسيط، ترتفع الأيقونة 5 بكسل */
            }
        }
        .btn-add-to-cart:hover .fa-caret-down {
            color: red; /* لتغيير لون الأيقونة عند تحويل المؤشر فوقها */
            animation: bounce 0.5s infinite; /* تطبيق الرسم البياني للتحرك بشكل مستمر */
            font-size: 24px; /* زيادة حجم الأيقونة */
            box-shadow: 0 0 10px red; /* إضافة حاشية حمراء حول الأيقونة */
        }
    </style>
 <a href="alternative.php?id=<?php echo $row["id"] ?>" class="btn btn-add-to-cart position-absolute z-index-2 text-nowrap" style=" height:7px;width:10px; color: red; padding: 3px 5px; margin-top: 17px; margin-left: 17px; font-size:32px;" data-toggle="popover" data-placement="top" title="boycott">
        <i class="fa-solid fa-caret-down" style""></i> <!-- أيقونة السهم -->
    </a>
<?php
        }
?>
...
<div class="page-info">
    ...
    <ul class="pagination m-0">
		<!----------------first button------------------->
		<li class="page-item"><a class="page-link" href="?page-nr=1">1</a></li>
		<!----------------previous button------------------->
		<?php 
           if(isset($_GET['page-nr']) && $_GET['page-nr'] > 1){
        ?>
        <li class="page-item">
            <a class="page-link rounded-circle d-flex align-items-center justify-content-center" href="?page-nr=<?php echo $_GET['page-nr'] - 1 ?>" aria-label="Previous">
                <svg class="icon">
		...
		<?php
			...
			?>
		<li class="page-item">
            <a class="page-link rounded-circle d-flex align-items-center justify-content-center" aria-label="Previous">
                <svg class="icon">
                    <use xlink:href="#icon-angle-double-left"></use>
                </svg>
            </a>
        ...
        <li class="page-item">
            <a class="page-link rounded-circle d-flex align-items-center justify-content-center" href="?page-nr=2" aria-label="Next">
                <svg class="icon">
        ...
        ?>
		<li class="page-item">
            <a class="page-link rounded-circle d-flex align-items-center justify-content-center" aria-label="Next">
                <svg class="icon">
                    <use xlink:href="#icon-angle-double-right"></use>
                </svg>
            </a>
	    ...
	    ?>
		<li class="page-item">
            <a class="page-link rounded-circle d-flex align-items-center justify-content-center" href="?page-nr=<?php echo $_GET['page-nr'] + 1 ?>" aria-label="Next">
                <svg class="icon">
                    <use xlink:href="#icon-angle-double-right"></use>
                </svg>
            </a>
		...
		<li class="page-item"><a class="page-link" href="?page-nr=<?php echo $pages ?>"><?php echo $pages ?></a></li>
	<?php
       }
      ?>
    </ul></div>
